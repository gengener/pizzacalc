...
export const defaults:Recipe={balls:6,ballWeight:250,hydration:72.5,yeast:'idy'};
...
export function initialRecipe(q:string,storedYeast:string|null):Recipe{const linked=decode(q);if(linked)return linked;const yeast:Yeast=storedYeast==='fresh'||storedYeast==='idy'?storedYeast:defaults.yeast;return{...defaults,yeast}}
